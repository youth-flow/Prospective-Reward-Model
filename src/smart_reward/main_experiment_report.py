"""Build and validate the compact, audited Main Experiment v1 result bundle.

This module is a reporting-only transform. It never recomputes a learned direction
or reads test results to modify the experiment. The dense sweep remains immutable;
